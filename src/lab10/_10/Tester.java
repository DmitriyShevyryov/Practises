...
public class Tester {
    ...
    public static void main(String[] args)
    {
        ...
        students[0]=new Student("Алексей", "Иванов", "Программист", 1, 3 );
        students[1]=new Student("Борис", "Широков", "Программист", 4,4 );
        students[2]=new Student("Владимир", "Смирнов", "Химик", 4, 5);
        students[3]=new Student("Григорий", "Чернов", "Юрист", 2, 6);
        students[4]=new Student("Дмитрий", "Петров", "Историк", 3,1 );
